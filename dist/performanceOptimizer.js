...
exports.PerformanceReporter = exports.PerformanceOptimizer = void 0;
class PerformanceOptimizer {
    ...
    async processLargeFile(content, progress, token) {
    ...
    async processWithStreaming(content) {
        const lines = content.split('\n');
        const totalLines = lines.length;
    ...
    updateProgress(current, total, message) {
        if (!this.progress || !this.options.enableProgressTracking)
            return;
    ...
    updateMetrics(chunk, processingTime) {
    ...
    static estimateProcessingTime(content, options) {
        const lines = content.split('\n').length;
...
class PerformanceReporter {
    ...
    static generateDetailedReport(metrics, chunks) {
        const report = [
