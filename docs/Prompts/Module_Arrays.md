<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_Arrays.md
Role: Specialized guidance for AutoHotkey v2 array manipulation
Updated: 2025-10-10
Keywords: array, transform, map, filter, reduce, chunk, list
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Detects array-centric requests and maps them to creation, transformation, and performance patterns.
- Provides tiered reasoning cues, reusable code snippets, and validation steps for array operations.
- Cross-links with data storage, text processing, and GUI modules to support composite scenarios.
</RETRIEVAL_ABSTRACT>

<NAVIGATION>
PrimaryModules:
- Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
- Supplemental_CustomGPT/Module_DataStructures.md
...
<ROLE_INTEGRATION>
You operate under the CustomGPT instruction set defined in Supplemental_CustomGPT/Modules_CustomGPT_Beta.md. This Module_Arrays.md provides specialized array knowledge that extends your core capabilities. 
...
6. Apply ALL syntax validation rules from the CustomGPT instructions
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation cues, and references to Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
