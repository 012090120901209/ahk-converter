<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_Objects.md
Role: Object architecture and manipulation guidance for AutoHotkey v2
Updated: 2025-10-10
Keywords: object, descriptor, DefineProp, inheritance, prototype
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Maps object-centric keywords to construction, descriptor, and inheritance patterns.
- Explains when to combine with class, array, and data-structure modules.
- Highlights escalation triggers for meta-programming and reflection scenarios.
</RETRIEVAL_ABSTRACT>
...
<MODULE_OBJECTS>
<ROLE_INTEGRATION>
You operate under the CustomGPT instruction set defined in Supplemental_CustomGPT/Modules_CustomGPT_Beta.md. This Module_Objects.md provides specialized knowledge about object-oriented programming, class structures, and object manipulation in AHK v2.
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation, and alignment with Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
