<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_Classes.md
Role: Specialized guidance for AutoHotkey v2 class and OOP patterns
Updated: 2025-10-10
Keywords: class, inheritance, encapsulation, __Get, __Set, prototype
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Provides tiered guidance for class design, lifecycle management, and advanced meta-programming.
- Maps OOP-related keywords to constructors, inheritance strategies, and descriptor patterns.
- Links to supporting modules for arrays, objects, errors, and GUI integration when classes span multiple concerns.
</RETRIEVAL_ABSTRACT>
...
<ROLE_INTEGRATION>
You operate under the CustomGPT instruction set defined in Supplemental_CustomGPT/Modules_CustomGPT_Beta.md. This Module_Classes.md provides specialized class knowledge that extends your core capabilities.
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation table, and references to Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
