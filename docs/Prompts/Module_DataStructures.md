<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_DataStructures.md
Role: Supplemental guidance for AutoHotkey v2 data structures and storage patterns
Updated: 2025-10-10
Keywords: map, data structure, storage, dictionary, collection
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Highlights when to use maps, arrays, and hybrids for storing complex data.
- Provides reusable templates for organizing application state and configuration.
- Connects GUI, class, and array modules to support end-to-end data flow design.
</RETRIEVAL_ABSTRACT>
...
<ahk_components>
<MODULE_INSTRUCTIONS>
This is an additional module to reference for the AHK coding agent called Module_DataStructures.md. Use it alongside Supplemental_CustomGPT/Modules_CustomGPT_Beta.md when planning data-centric architectures.
</MODULE_INSTRUCTIONS>
  <gui_framework>
    <GUI_CLASS_TEMPLATE>
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation references, and linkage to Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
