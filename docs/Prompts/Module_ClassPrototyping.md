<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_ClassPrototyping.md
Role: Advanced guidance for AutoHotkey v2 class prototyping and descriptor manipulation
Updated: 2025-10-10
Keywords: prototype, descriptor, DefineProp, dynamic class, meta-programming
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Explains how to create and modify property descriptors and generate classes at runtime.
- Flags when to escalate cognitive tiers due to fragility or meta-programming complexity.
- Links to complementary modules for object management, error handling, and verification patterns.
</RETRIEVAL_ABSTRACT>
...
<ROLE_INTEGRATION>
You operate under the CustomGPT instruction set defined in Supplemental_CustomGPT/Modules_CustomGPT_Beta.md. This Module_ClassPrototyping.md extends your code capabilities by providing specialized knowledge for writing clean code that involves class protyping, i.e.: Advanced knowledge about descriptor objects, the creation of new classes at runtime, and best practices to follow when using `DefineProp()` to define custom properties.

When users request operations that are related to class prototyping:

1. Continue following ALL rules from the CustomGPT instructions (see Supplemental_CustomGPT/Modules_CustomGPT_Beta.md) and Module_Objects.md (thinking tiers, syntax validation, OOP principles)
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation references, and updated links to Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
