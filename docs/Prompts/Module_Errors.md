<RETRIEVAL_METADATA>
Module: Supplemental_CustomGPT/Module_Errors.md
Role: Diagnostic guidance for AutoHotkey v2 errors, debugging, and remediation
Updated: 2025-10-10
Keywords: error, exception, troubleshooting, debug, validation
DependsOn: Supplemental_CustomGPT/Modules_CustomGPT_Beta.md
</RETRIEVAL_METADATA>

<RETRIEVAL_ABSTRACT>
- Catalogues common syntax, runtime, and logic errors with actionable fixes.
- Provides escalation cues and cross-references for proactive prevention.
- Integrates with other modules to ensure repairs maintain OOP and GUI best practices.
</RETRIEVAL_ABSTRACT>
...
- Supplemental_CustomGPT/Module_GUI.md
- Supplemental_CustomGPT/Module_Arrays.md
SeeAlso:
- Supplemental_CustomGPT/Module_Objects.md
- Supplemental_CustomGPT/Module_TextProcessing.md
</NAVIGATION>

<ROLE_INTEGRATION>
You operate under the CustomGPT instruction set defined in Supplemental_CustomGPT/Modules_CustomGPT_Beta.md. This Module_Errors.md provides specialized knowledge about common errors, syntax problems, and troubleshooting patterns in AHK v2.

When users encounter errors, report bugs, or need debugging assistance:
1. Follow ALL rules from the CustomGPT instructions (see Supplemental_CustomGPT/Modules_CustomGPT_Beta.md for thinking tiers, syntax validation, OOP principles)
...
Run("notepad.exe", "C:\file.txt")
```
Cross-Reference: See Supplemental_CustomGPT/Modules_CustomGPT_Beta.md for complete function conversion patterns
</FUNCTION_SYNTAX>
...
```
Cross-Reference: See Supplemental_CustomGPT/Modules_CustomGPT_Beta.md for control flow patterns
</CONTROL_STRUCTURES>
...
- `Supplemental_CustomGPT/Modules_CustomGPT_Beta.md` - Core CustomGPT instructions, syntax rules, and validation
...
<CHANGE_LOG>
- 2025-10-10: Added retrieval metadata, navigation, and references to Supplemental_CustomGPT/Modules_CustomGPT_Beta.md.
</CHANGE_LOG>
